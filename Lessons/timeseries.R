...
y
x_1_bez_time = format(as.Date(x$date_with_time),"%Y-%m-%d")
...
y_month = ymd("2014-01-01")+months(0:4)
y_month

y_blabla = ymd("2014-01-01") + months(0:4) + days(0:4)
...
getSymbols(Symbols = "ETR:BMW", from = "2010-01-01", to = "2017-11-03", src = "google")
head(ETR:BMW)
tail(AAPL)
